    ...
    <aside style={{
      ...
      <div style={{
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <p style={{ fontSize: 12, color: '#fff', fontWeight: 500, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{user?.username}</p>
          <p style={{ fontSize: 11, color: 'rgba(255,255,255,0.4)' }}>Freelance</p>
        </div>
